...
- [Projektopgave](../developer/entities/msdyn_projecttask.md)
- [Ressourcetildelinger](../developer/entities/msdyn_resourceassignment.md)
- [Projektopgaveafhængighed](../developer/entities/msdyn_projecttaskdependency.md)
- [Reserverbare ressourcer](../developer/entities/bookableresource.md)

Hvis du vil definere en ressources indlæste arbejdsopgavehierarki, skal du udføre følgende trin:

1. Oprette et nyt projekt. Du finder flere oplysninger om, hvordan du opretter et nyt projekt i [msdyn_project](../developer/entities/msdyn_project.md).
2. Oprette en eller flere opgaver. Du finder flere oplysninger om, hvordan du opretter en opgave i [msdyn_projecttask](../developer/entities/msdyn_projecttask.md).
3. Definere opgaveafhængigheder. Du kan finde flere oplysninger i [Projektopgaveafhængighed](../developer/entities/msdyn_projecttaskdependency.md).
4. Tildele projektteammedlemmer til projektet. Du kan finde flere oplysninger i [msdyn_projectteam](../developer/entities/msdyn_projectteam.md).
5. Tildele projektteammedlemmer til opgaverne. Du kan finde flere oplysninger i [msdyn_resourceassignment](../developer/entities/msdyn_resourceassignment.md).
