...
description: Denne artikel indeholder oplysninger om, hvordan du arbejder på tilbud med flere kunder, som skal finansiere projektet. (Sales)
author: rumant
ms.date: 10/01/2020
ms.topic: article
