...
description: Denne artikel indeholder oplysninger om, hvordan du kan administrere ressourcer.
author: ruhercul
ms.custom:
...
5. Vælg **Reservér** på siden **Ressourcekrav** for at opfylde ressourcekravet.
    ...
    ![Knappen Reservér på siden Ressourcekrav.](media/Resource-Management-image13.png)
...
9. Vend tilbage til visningen **Alle teammedlemmer**. Bemærk, at den generiske ressource er blevet erstattet af den navngivne ressource i gitteret, og at 40 timer vises som reserveret for den pågældende ressource.
    ...
    ![Opdateret gitter for Alle teammedlemmer.](media/Resource-Management-image20.png)
...
5. Vælg den generiske ressource, og vælg derefter **Generer krav** under fanen **Team**.
    ...
    ![Generiske ressourcetildelinger er erstattet med den navngivne ressource under fanen Tidsplan.](media/Resource-Management-image31.png)
    ...
    ![Fem dages opgave med 80 timer er tildelt den generiske funktionelle ressource.](media/Resource-Management-image32.png)
...
4. Hvis du ved, hvilken ressource du vil bruge som erstatning for den aktuelle ressource, skal du vælge eller skrive navnet og derefter vælge **Tildel igen**.
    ...
    ![Angivelse af en erstatningsressource.](media/Resource-Management-image51.png)
    ...
    2. Når du vil erstatte ressourcen, skal du vælge den ressource, du vil bruge, og derefter vælge **Erstat**.
        ...
        ![Erstatningsressource er valgt.](media/Resource-Management-image54.png)

    Reservationerne og tildelingerne erstattes med den nye ressource.

    ![Reservationer og tildelinger er erstattet med den nye ressource.](media/Resource-Management-image55.png)
