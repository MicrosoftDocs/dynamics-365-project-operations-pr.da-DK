---
title: Synkroniser faktiske projektværdier direkte fra Project Service Automation med projektintegrationskladden til bogføring i finans og drift
description: I denne artikel beskrives de skabeloner og underliggende opgaver, der bruges til at synkronisere faktiske projektoplysninger direkte fra Microsoft Dynamics 365 Project Service Automation til finans og drift.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9028971"
---
# <a name="synchronize-project-actuals-directly-from-project-service-automation-to-the-project-integration-journal-for-posting-in-finance-and-operations"></a>Synkroniser faktiske projektværdier direkte fra Project Service Automation med projektintegrationskladden til bogføring i finans og drift
...
[![Dataflow for Project Service Automation-integration med finans og drift.](./media/ProjectActualsFlow.jpg)](./media/ProjectActualsFlow.jpg)
