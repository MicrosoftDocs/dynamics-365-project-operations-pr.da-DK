...
description: Denne artikel indeholder generelle oplysninger om programmer relateret til projekttid til Microsoft Dynamics 365 Project Timesheet, Tidsregistrering for projekt og Mine timesedler/Timesedler, som er tilgængelige på en mobilenhed.
author: Yowelle
ms.date: 05/28/2019
ms.topic: overview
ms.prod: ''
...
Med mobilappen til Dynamics 365 Project Timesheet kan brugerne sende og godkende timesedler for projekter på deres mobilenheder. Denne mobilapp omhandler timeseddelfunktionaliteterne i området Projektstyring og regnskab i Dynamics 365 Finance. Den bidrager til at forbedre brugernes produktivitet og effektivitet og er også med til at sikre, at projekttimesedler registreres og godkendes rettidigt.
